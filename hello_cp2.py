...
@app.route("/predict1/<string:filename>", methods=["POST", "GET"])
def predict1(filename):
    args = parse_args()
    ...
    if flask.request.method == 'GET':
        ...
        # data['width'] = image1.size[0]
        # data['height'] = image1.size[1]
        # if image1.mode == 'RGBA':
        #     print(filename)
        ...
        print('file_pathhhh',file_path)
        im_in = np.array(imread(file_path))
    ...
    for j in range(1, len(pascal_classes)):
        ...
        if inds.numel() > 0:
           ...
           # if vis:
               ...
               # im2show = vis_detections(im2show, pascal_classes[j], 0.5)
